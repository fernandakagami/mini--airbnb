	...
	return (
		<Sheet open={open} onOpenChange={setOpen}>
			<SheetTrigger asChild>
				<Button className="not-sr-only w-full py-6 md:sr-only">
					<Search size={20} />
					Inicie sua busca
				</Button>
			</SheetTrigger>
			<SheetContent className="max-h-screen overflow-y-auto">
				<SheetHeader>
					...
					<SheetDescription>Refine sua busca de acomodações com os filtros abaixo.</SheetDescription>
				</SheetHeader>
				<div className="px-3">
					<Form {...formMethods}>
						<form
				...
				<SheetFooter className="mt-3">
					<SheetClose asChild>
						<Button variant="outline" className="mx-3" onClick={clearForm}>
							Limpar Filtro
						</Button>
					</SheetClose>
				</SheetFooter>
